...
DEFAULT_MODEL = "FastVideo/FastWan-QAD-FP8-1.3B"
# FLASH_ATTN: on H100, SageAttention2 measured equal to Flash for this
# 1.3B/480p/3-step workload (full SA2 vs Flash within ~3%), so we run Flash and
# skip the SageAttention source build. The FP4/SageAttention3 path is Blackwell
# sm_120-only and irrelevant here. TORCH_SDPA is the slow generic fallback.
DEFAULT_ATTENTION_BACKEND = "FLASH_ATTN"
DEFAULT_MODEL_LABEL = "fastwan-qad-fp8"
...
PRODUCTION_SHAPES_JSON_PATH = "/opt/app/fastwan/shapes.json"
