...
pub struct StandaloneIndexerMetrics {
    ...
    /// h24 mode: age of each matched block at query time, labeled
...
#[cfg(feature = "metrics")]
pub fn h24_observe_age(kind: &str, age_s: u32) {
    METRICS
        .h24_age_seconds
        .with_label_values(&[kind])
        .observe(age_s as f64);
}

#[cfg(not(feature = "metrics"))]
pub fn h24_observe_age(_kind: &str, _age_s: u32) {}
